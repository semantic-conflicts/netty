...
public class LengthFieldBasedFrameDecoder extends FrameDecoder {
  ...
  public int lengthFieldEndOffset;
  public int lengthAdjustment;
  public int initialBytesToStrip;
  public boolean lengthFieldIncludedInFrameLength;
  public boolean discardingTooLongFrame;
  public long tooLongFrameLength;
  public long bytesToDiscard;
  public boolean failImmediatelyOnTooLongFrame=false;
  /** 
 * Creates a new instance.
 * @param maxFrameLength the maximum length of the frame.  If the length of the frame is greater than this value,  {@link TooLongFrameException} will bethrown.
 ...
 * @param lengthAdjustment the compensation value to add to the value of the length field
 * @param initialBytesToStrip the number of first bytes to strip out from the decoded frame
 * @param lengthFieldIncludedInFrameLength whether to count length field into frame length
 */
...
public void failIfNecessary(ChannelHandlerContext ctx,boolean firstDetectionOfTooLongFrame){
if (bytesToDiscard == 0) {
...
public void fail(ChannelHandlerContext ctx,long frameLength){
if (frameLength > 0) {
